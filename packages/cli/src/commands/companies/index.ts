 ...
 * COMPANY noun in API contracts (Client Archetype governance, the portal's
 * "New Client Creation Form" GA, v2 quotes API `clientId`); the CLI adopts
 * the canonical user-facing noun. JSON output fields (`companyId`,
